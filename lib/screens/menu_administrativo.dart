...
class MenuAdministrativo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, dynamic>> modulos = [
      {
        'titulo': 'Ventas',
        'subtitulo': 'Terminal de mostrador rápida',
      ...
      {
        'titulo': 'Pedido',
        'subtitulo': 'Recepción y captura de especiales',
      ...
      {
        'titulo': 'Producción',
        'subtitulo': 'Control de cocina y decoración',
      ...
      {
        'titulo': 'Catálogo',
        'subtitulo': 'Gestor de recetas y álbumes',
      ...
      {
        'titulo': 'Ver Pedidos',
        'subtitulo': 'Línea de tiempo de entregas',
      ...
      },
      {
        ...
        'subtitulo': 'Flujo de caja y rendimiento',
        'icono': Icons.account_balance_wallet_rounded,
        'color': const Color(0xFF16A085), // Turquesa
        'pantalla': const EstadoCuentaScreen(),
      },
      {
        'titulo': 'Inventario',
        'subtitulo': 'Gestión de stock e insumos',
        'icono': Icons.inventory_2_rounded,
        'color': const Color(0xFFC0392B), // Rojo
        'pantalla': const InventarioScreen(),
      },
      {
        'titulo': 'Usuarios',
        'subtitulo': 'Gestión de roles y accesos',
        'icono': Icons.people_alt_rounded,
        'color': const Color(0xFF34495E), // Slate/Gris oscuro azulado
    ...
    return Scaffold(
      ...
      endDrawer: const Drawer(
        width: 400,
        child: NotificacionesPanel(rol: 'administrador'),
      ),
      body: SafeArea(
        child: Column(
            ...
            Expanded(
              child: LayoutBuilder(
                builder: (context, constraints) {
                  // Mismo cálculo original para que sean grandotes
                  double spacing = 20;
                  int filas = 2; // 2 filas principales si la pantalla es ancha
                  if (constraints.maxHeight > 800) filas = 3;
                  
                  double buttonSize = (constraints.maxHeight - (spacing * (filas + 1))) / filas;
                  double maxWidthButton = (constraints.maxWidth - spacing * 3) / 4; // Max 4 columnas
                  if (buttonSize > maxWidthButton) buttonSize = maxWidthButton;
                  
                  // Limitar tamaño para que no sea absurdamente grande en monitores enormes
              ...
              children: [
                ...
                AnimatedContainer(
                  ...
                  child: Icon(
                    ...
                    size: widget.size * 0.35, // 35% del tamaño del botón
                  ),
                ),
                SizedBox(height: widget.size * 0.1), // Espaciado proporcional
                ...
                Padding(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: (widget.size * 0.09).clamp(14.0, 20.0), // Tamaño fuente proporcional
